...
of the Gold Bouncer V3 Pine Scripts:
  - GoldBouncer_V3_Reversal_FixedSL.pine     (Bot 1 - fixed_sl)
  - GoldBouncer_V3_Reversal_TrailingSL.pine   (Bot 2 - trailing_sl)
...
# Bot 1 - Reversal with Fixed SL (Heikin Ashi signals)
BOT1_API_KEY    = os.environ.get("BOT1_API_KEY")
BOT1_API_SECRET = os.environ.get("BOT1_API_SECRET")

# Bot 2 - Reversal with Trailing SL (Heikin Ashi signals)
...
def webhook():
    ...
    Bot 1 (Fixed SL) - from GoldBouncer_V3_Reversal_FixedSL.pine [HA]:
    {
        "token":  "goldbouncerv3",
        "bot":    "fixed_sl",
        "signal": "buy" or "sell",
    ...
    Bot 2 (Trailing SL) - from GoldBouncer_V3_Reversal_TrailingSL.pine [HA]:
    {
        "token":  "goldbouncerv3",
        "bot":    "trailing_sl",
        "signal": "buy" or "sell",
